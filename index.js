...
// ローカルMongoDBの場合（例）:
const MONGODB_URI = 'mongodb+srv://kn2030kn03_db_user:gombee001@cluster0.udgmw6h.mongodb.net/gatya-db?retryWrites=true&w=majority&appName=Cluster0';// MongoDB Atlasの場合（コメントアウトを外して自分の情報に書き換え）:
/*
